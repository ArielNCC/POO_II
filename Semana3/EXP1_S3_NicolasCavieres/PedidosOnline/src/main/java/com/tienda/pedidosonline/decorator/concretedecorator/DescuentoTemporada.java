...
/**
 * Decorador concreto que aplica un descuento por temporada
...
public class DescuentoTemporada extends DescuentoDecorator {
    ...
    public DescuentoTemporada(Component componente, double porcentaje) {
        super(componente);
    ...
    public String getDescripcion() {
        return componente.getDescripcion() + " [Descuento Temporada]";
    }
